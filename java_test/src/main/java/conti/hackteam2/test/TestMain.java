...
package conti.hackteam2.test;

import conti.hackteam2.test.controller.TestController;
...
public class TestMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        TestController testController = new TestController(executor);

        LOGGER.info("testController.start()");
        int returnCode = testController.start(url, realm);
